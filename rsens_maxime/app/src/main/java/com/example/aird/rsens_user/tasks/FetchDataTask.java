...
import com.example.aird.rsens_user.activities.DayActivity;
 ...
 *
 * Recupere les données du jour et du capteur choisis
 */

public class  FetchDataTask extends AsyncTask<URL,Integer,JSONObject> {
    //param pour stocker l'activity, specifique car doit ecrire fonction (vu plus tard)
    DayActivity activity;

    //stock l'activity
    public FetchDataTask(DayActivity activity){
    ...
    protected JSONObject doInBackground(URL... urls) {
        Log.e("doInBackground Entry", "doInBackground Entry");
        ...
        try {
            ...
            Log.e("doInBackground url", "doInBackground url : " + url);
            //connection etablie
    ...
    protected void onPostExecute(JSONObject jsonObject) {
        ...
        if(jsonObject==null){
            ...
            activity.updateDataView(jsonObject);
        }
    }
}
