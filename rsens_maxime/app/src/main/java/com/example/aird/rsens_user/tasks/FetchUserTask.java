...
import com.example.aird.rsens_user.activities.MainActivity;
 ...
 *
 * Verifie si les identifiants donnes sont correcte si oui alors connexion.
 */

public class FetchUserTask extends AsyncTask<URL,Integer,JSONObject> {
    //param pour stocker l'activity, specifique car doit ecrire fonction (vu plus tard)
    MainActivity activity;

    //stock l'activity
    public FetchUserTask(MainActivity activity){
