...
public class DeviceScanActivity extends ListActivity {
    ...
    private void scanLeDevice21(boolean enable) {
        ...
        if (enable) {
            ...
            mScanning = true;
            mLeScanner.startScan(mLeScanCallback21);
        } else {
            mScanning = false;
            mLeScanner.stopScan(mLeScanCallback21);
        }
    ...
    //Lors du backPress ne fait rien.
    @Override
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            // Permet d'empecher de revenir en arrière avec le backPress
    ...
    /**
     * Callback pour les version d'android inférieur à 21.
     */
    ...
    /**
     * Callback pour les version d'android à partir de 21.
     */
