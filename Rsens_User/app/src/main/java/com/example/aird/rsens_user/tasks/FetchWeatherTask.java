...
import com.example.aird.rsens_user.activities.DeviceControlActivity;
...
public class FetchWeatherTask extends AsyncTask<URL,Integer,JSONObject> {
    //param pour stocker l'activity, specifique car doit ecrire fonction (vu plus tard)
    DeviceControlActivity activity;

    //stock l'activity
    public FetchWeatherTask(DeviceControlActivity activity){
