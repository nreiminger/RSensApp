...
public class InfoActivity extends Activity {
    ...
    public void saveData() {
        ...
        editor.putString(NOTIFON, notifOn+"");
        editor.putString(NOTIFPM, notifPM+"");
        editor.putString(LANG, sLocale);
    ...
    public void loadData() {
        SharedPreferences sharedPreferences = getSharedPreferences(SHARED_PREFS, MODE_PRIVATE);
        uNotifOn = sharedPreferences.getString(NOTIFON, "");
        uNotifPM = sharedPreferences.getString(NOTIFPM, "");
